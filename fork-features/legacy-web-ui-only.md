...
- Upstream tests and E2E specs remain unchanged even when their v2 surfaces are unreachable under this policy.
- Do not add skip markers, fork test helpers, viewport accommodations, or fork-specific assertions.
- Broader test suites are not maintained or run for this fork; verification uses the required package build and manual observation of the behavior below.
